#!/bin/sh
# Download the latest APFPV firmware from OpenIPC nightly builds.
# Overwrites any previously cached firmware with the newest version.

set -eu

FIRMWARE_URL="https://github.com/OpenIPC/builder/releases/download/nightly/ssc338q_apfpv_greg-generic-bu-eu-nor.tgz"
...
echo "[gs] Downloading latest APFPV firmware ..."
